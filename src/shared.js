...
export const createMovieCard = (movie, isDiary = false) => {
  ...
  templateDiv.classList.add('bg-gray-800', 'rounded-lg', 'overflow-hidden', 'shadow-lg', 'flex', 'movie-card', 'relative');
...
addToDiaryIcon.classList.add('fa-regular', 'fa-heart', 'text-4xl', 'hover:text-pink-600', 'transition-transform', 'hover:scale-110', 'duration-300');
...
removeFromDiaryIcon.classList.add('fa-solid', 'fa-heart', 'text-4xl', 'hover:text-pink-600', 'transition-transform', 'hover:scale-110', 'duration-300');
